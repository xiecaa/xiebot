...
//>>>>>>>>>[ KHUSUS DOWNLOAD ]<<<<<<<<<<\\
         ...
         case 'play':
              ...
              imageMessage = (await xiedev.prepareMessageMedia({url:res.all[0].image},'imageMessage',{thumbnail:Buffer.alloc(0)})).imageMessage
              buttonsMessage = {contentText: thumbInfo,footerText:'Silahkan Pilih Dibawah Ini',imageMessage,buttons,headerType:4}
              prepp = await xiedev.prepareMessageFromContent(from,{buttonsMessage},{quoted: team, contextInfo: {"mentionedJid": [sender]}})
